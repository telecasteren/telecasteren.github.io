...
rocketCursor.classList.add("rocketCursor");

document.body.appendChild(rocketCursor);

export function displayCustomCursor(mode) {
  if (mode === "light") {
    rocketCursor.innerHTML = `
  ...
  `;
    ...
    <svg width="50" height="50" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <!-- Body -->
      <path d="M50 10 L75 40 L50 90 L25 40 Z" stroke="#ffffffde" stroke-width="4" fill="none"/>
      
      <!-- Window -->
      <circle cx="50" cy="35" r="7" stroke="#ffffffde" stroke-width="4" fill="none"/>
      
      <!-- Fins -->
      <path d="M25 50 L10 80" stroke="#ffffffde" stroke-width="4" fill="none"/>
      <path d="M75 50 L90 80" stroke="#ffffffde" stroke-width="4" fill="none"/>
